...
(let ((base00 "#2b303b") ;; background
      (base01 "#343d46") ;; fringe
      (base02 "#4f5b66") ;; line highlight
      (base03 "#65737e") ;; comment
      (base04 "#a7adba") ;; mode-line
      (base05 "#c0c5ce") ;;
      (base06 "#dfe1e8") ;;
      (base07 "#eff1f5") ;;
      (base08 "#bf616a") ;; variable
      (base09 "#d08770") ;; constant
      (base0A "#ebcb8b") ;; class
      (base0B "#a3be8c") ;; string literals
      (base0C "#96b5b4") ;; buffer id
      (base0D "#8fa1b3") ;; function names
      (base0E "#b48ead") ;; require statement
      (base0F "#ab7967"));;
  ...
  (custom-theme-set-faces
   ...
   `(region ((t (:background ,base0A :foreground ,base02))))
   ...
   ;; Font-lock stuff
   `(font-lock-builtin-face ((t (:foreground ,base0E))))
   ...
   ;; Flyspell
   `(flyspell-duplicate ((t (:underline ,base09 :background ,base01))))
   `(flyspell-incorrect ((t (:underline ,base08 :background ,base01))))

   ;; Flycheck
   `(flycheck-warning ((t (:underline ,base09 :background ,base01))))
   `(flycheck-fringe-warning ((t (:foreground ,base09))))
   `(flycheck-error ((t (:underline ,base08 :background ,base01))))
   `(flycheck-fringe-error ((t (:foreground ,base08))))
   `(flycheck-info ((t (:underline ,base0B :background ,base01))))
   `(flycheck-fringe-info ((t (:foreground ,base0B))))

   ;; git-gutter
   `(git-gutter-fr+-modified ((t (:foreground ,base0F))))
   ...
   `(eshell-ls-directory ((t (:foreground ,base0D :weight normal))))
   `(eshell-ls-symlink ((t (:foreground ,base0C :weight normal))))
   `(eshell-ls-executable ((t (:foreground ,base0B :weight normal))))
   `(eshell-ls-archive ((t (:foreground ,base08 :weight normal))))

   ;; Magit (a patch is pending in magit to make these standard upstream)
   `(magit-branch ((t (:foreground ,base0B))))
   `(magit-header ((t (:inherit nil :weight bold))))
   `(magit-diff-file-heading ((t (:inherit nil :weight normal))))
   ...
   ;; js2-mode
   `(js2-warning ((t (:underline ,base09 :background ,base01))))
   `(js2-error ((t (:underline ,base08 :background ,base01))))
