...
;;; base16-ap4y-dark-theme.el

;;; Code:

(deftheme base16-ap4y-dark)

(let ((base00 "#222222") ;; background
      (base01 "#c5c0c4") ;; fringe
      (base02 "#41433e") ;; line highlight

      (base03 "#9c979a") ;; comment

      (base04 "#b4afb1") ;; mode-line
      (base05 "#c5c0c4") ;;
      (base06 "#c5c0c4") ;;

      (base07 "#c5c0c4") ;;
      (base08 "#a79a9c") ;; variable
      (base09 "#763942") ;; constant
      (base0A "#9f928a") ;; class
      (base0B "#9da4a3") ;; string literals
      (base0C "#b2a6a7") ;; buffer id
      (base0D "#4c6d60") ;; function names
      (base0E "#7d928d") ;; require statement
      (base0F "#274646"));;
  ...
  (custom-theme-set-faces
   ...
   `(region ((t (:background ,base05 :foreground ,base02))))
   ...
   ;; Flyspell
   `(flyspell-duplicate ((t (:underline ,base0D))))
   `(flyspell-incorrect ((t (:underline ,base0C))))
...
(provide-theme 'base16-ap4y-dark)

;;; base16-ap4y-dark-theme.el ends here
