...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	" Diff Highlighting
	call <SID>X("DiffAdd", s:green, s:line, "bold")
	call <SID>X("DiffDelete", s:red, s:line, "bold")
	call <SID>X("DiffChange", s:comment, s:background, "bold")
	call <SID>X("DiffText", s:orange, s:line, "bold")
	...
	" objC
	call <SID>X("objcPointer", s:yellow, "", "")
	call <SID>X("objcSpecial", s:green, "", "")
